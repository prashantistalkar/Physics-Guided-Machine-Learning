...
This code predicts the 10 days of recession flow uing past 120 days of streamlfow data
...
import pandas as pd
# below is the code for LSTM with encoder decoder architecture
...
# calling functions
import os 
os.chdir(r"E:\Prashant\LSTM run\Revision\Time series") 
path = os.getcwd()
...
for i in range(0,len(filenames),1):
    ...
    [xtrain_norm,xtrain_mean,xtrain_std]=Normalize_data(xtrain)
